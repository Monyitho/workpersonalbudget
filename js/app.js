...
function mostraWizardSetup() {
  ...
  wizard.innerHTML = '<div style="width:100%;max-width:400px;padding:env(safe-area-inset-top,40px) 24px 40px 24px;margin:0 auto">'
    ...
    + '<div style="display:flex;align-items:center;justify-content:center;gap:8px;max-width:180px;margin:0 auto">'
    ...
    + '<input type="number" id="wizardNumBuoni" value="0" min="0" style="width:80px;' + wizInp + ';text-align:center;font-weight:700;border-color:rgba(255,152,0,0.2)">'
    + '</div>'
    ...
    + '<input type="number" id="wizardValoreBuono" value="10.50" min="0" step="0.01" style="width:80px;' + wizInp + ';text-align:center;font-weight:700;border-color:rgba(255,152,0,0.2)">'
    + '</div>'
    + '</div>'
        ...
        if (t.pagamentoMisto && t.metodiPagamento) {
          t.metodiPagamento.forEach(function(m) {
            if (m.pagatoDa === 'partner') {
              partnerPagaMisto += parseFloat(m.importo) || 0;
            }
          });
        }
        ...
        if (t.pagamentoMisto && t.metodiPagamento) {
          t.metodiPagamento.forEach(function(metodo) {
            if (metodo.pagatoDa === 'partner') {
              ...
              speseCondivise -= partnerPaid; // Non contare come tua spesa
            }
          });
        }
