...
function aggiornaGraficoDistribuzione(distribuzione, totaleSpese) {
  ...
  var html = '<div style="background:transparent;border-radius:0;padding:0;">';
...
function aggiornaWidgetObiettivi() {
  ...
  // Mostra solo i primi 4 obiettivi (griglia 2x2)
  DB.obiettivi.slice(0, 4).forEach(function(obj) {
  ...
  html += '</div>'; // chiude la griglia

  if (DB.obiettivi.length > 4) {
    html += '<div style="text-align:center;padding:10px;color:#e65100;font-size:0.85em;font-weight:600">+' + (DB.obiettivi.length - 4) + ' altri obiettivi</div>';
  }
