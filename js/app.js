...
function mostraTrans() {
  ...
  if (listaFiltrata.length === 0) {
    ...
    listaFiltrata.forEach(function(t) {
      ...
      // Colore distintivo per transazioni pagate dal partner
      if (t.chiHaPagato === 'partner' || t.tipo === 'partner_payment') {
      ...
      // Colore distintivo per transazioni con buoni pasto
      ...
      if (t.tipo === 'income') {
        ...
        if (dest === 'contanti') metodoPagamento = '💵 Contanti';
        else if (dest === 'buoni_pasto') metodoPagamento = '🎟️ Buoni Pasto';
        else metodoPagamento = '💳 Carta/Conto';
      } else {
        ...
        } else if (t.metodo === 'buoni_pasto') {
          metodoPagamento = '🎟️ Buoni Pasto';
        } else {
          metodoPagamento = '💳 Carta/Conto';
        }
      }
