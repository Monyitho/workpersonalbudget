...
function mostraTrans() {
  ...
  if (listaFiltrata.length === 0) {
    ...
    dateOrdinate.forEach(function(dataKey) {
      ...
      if (t.condiviso) {
        if (isPartnerPaid) {
          badges += '<span class="condiviso-tag" style="color:#e91e63">PARTNER</span>';
        } else {
          badges += '<span class="condiviso-tag" style="color:#e74c3c">50/50</span>';
        }
      }
      if (t.virtualRecovery) badges += '<span class="condiviso-tag" style="color:#9b59b6">REC</span>';
