...
function mostraCalendario() {
  ...
  for (var d = 1; d <= giorniMese; d++) {
    ...
    html += '<div onclick="mostraGiornoCalendario(' + d + ')" style="' + bgStyle + 'border-radius:8px;padding:6px 2px;text-align:center;cursor:' + (hasTrans ? 'pointer' : 'default') + ';min-height:42px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px">';
...
function mostraGiornoCalendario(giorno) {
  ...
  if (trans.length === 0) { det.style.display = 'none'; return; }
